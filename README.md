...
2. (Opcional) Defina `Root Directory` como `frontend` **ou** mantenha na raiz usando o `vercel.json` já incluído.
3. Configure a variável de ambiente `VITE_API_URL` apontando para sua API publicada.
