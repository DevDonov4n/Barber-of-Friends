    ...
    <main className="site-shell">
      <section className="page booking-page">
        ...
        <p className="page-subtitle">
          Atendimentos de 30 em 30 minutos, das 09:00 às 20:30. <strong>Domingo não possui agendamento.</strong>
        </p>
        ...
        <section className="booking-panel glass">
          ...
          <p className="booking-hint">
            A cada 5 cortes concluídos com o barbeiro, o próximo corte premium recebe 50% de desconto.
          </p>
          ...
          {!logged && (
            <div className="guest-fields">
              ...
              <p>
                Quer acompanhar seu histórico depois? <a href="/cadastro">Crie uma conta</a>.
              </p>
            </div>
          )}
          ...
          <div className="time-grid">
            {slots.map((slot) => {
              const occupied = unavailable.some(
                (appointment) => appointment.time.slice(0, 5) === slot
              );

              return (
                <button
                  key={slot}
                  disabled={occupied || isSunday}
      ...
      {confirmation && (
        <div className="confirmation-overlay" role="dialog" aria-modal="true">
          <div className="confirmation-modal glass">
            ...
            <p>
              Obrigado, <strong>{confirmation.name}</strong>. Preparamos seu horário na Barber of Friends.
            </p>
            ...
            <button className="btn btn-primary" onClick={() => setConfirmation(null)}>
              Fechar
            </button>
          </div>
        </div>
